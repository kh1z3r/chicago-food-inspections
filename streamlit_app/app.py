...
nav = st.navigation([
    ...
    st.Page("pages/3_Neighborhood_Effect.py", title="2  Neighborhood Effect"),
    st.Page("pages/4_Threshold_Tuning.py", title="3  Threshold Tuning"),
    st.Page("pages/5_Fairness_Audit.py", title="4  Fairness Audit"),
    st.Page("pages/6_Enforcement_Check.py", title="5  Enforcement Check"),
    st.Page("pages/7_Conclusions.py", title="6  Conclusions"),
])
nav.run()
